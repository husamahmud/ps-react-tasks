...
function WinnerPopUp({showpop , winnerMessage , setShowpop , reset} : IWinnerPopUpProps) {
    ...
    return (
        <div onClick={hideWinnerPopUp} className={`popup fixed top-0 left-0 w-full h-full bg-[#0000009f] z-[100] flex items-center transition-opacity opacity-0
        ${showpop && "opacity-100"}`}>
