...
export default function App() {
  ...
  return (
    <div className="flex justify-center h-screen">
      <div className="mt-8 w-11/12 md:w-10/12 lg:w-8/12 xl:w-6/12 ">
        <Header />

        <div className="flex flex-col sm:flex-row divide-y-2 sm:divide-x-2 sm:divide-y-0 divide-solid divide-green-500">
